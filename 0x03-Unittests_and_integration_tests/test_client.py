...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org_name, expected, mock_get_json):
        """Tests that the org method returns the expected output"""
    ...
    def test_public_repos_url(self):
        """Tests that the _public_repos_url property returns the expected
        output"""
        with patch(
    ...
    def test_public_repos(self, get_json):
        """Tests that the public_repos method returns the expected output"""
        test_payload = {
